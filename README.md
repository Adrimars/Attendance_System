...
> Attendance System for IZTECH World Dance Society.A full-screen Windows kiosk application for tracking student attendance in a dance studio using RFID card readers. Built with Python, CustomTkinter, and SQLite3.
...
```bash
git clone [https://github.com/Adrimars/Attendance_System.git](https://github.com/Adrimars/Attendance_System.git)
