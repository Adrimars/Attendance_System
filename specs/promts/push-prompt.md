...
|------------|----------------|-------------|
| 2026-07-03 | `eebb7a3`      | feat: multi-page Sheets import — reads names from the "Kayıt Formu Sonuçları" registration tab alongside Sayfa1 in one run; form names always import and allow duplicates |
